...
$sql="INSERT INTO sample_table_last (username, email, dob, age, gender, phone, pin, blood, feedback) VALUES ('$_POST[username]','$_POST[email]','$_POST[dob]','$_POST[age]','$_POST[gender]','$_POST[phone]','$_POST[pin]','$_POST[blood]','$_POST[feed]')";
